...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ route('allLoansApplications') }}">Dashboard</a></li>
        <li class="breadcrumb-item active" aria-current="page">Broker Loans application</li>
    </ol>
</nav>
...
<link href="https://cdn.datatables.net/buttons/2.4.1/css/buttons.dataTables.min.css" rel="stylesheet"/>
         ...
         <div style="padding: 1%"> 
            <h1><center>Broker Submitted Loans Applications</center></h1> 
                 <!-- DataTales Example -->
                 <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Loan List</h6>
                            <div class="d-flex justify-content-end">
                                <a class="btn btn-primary" href="addLoan" ><i class="fa fa-plus"></i>  Add Loan</a>
                            </div>
                        </div>
                            ...
                            <table id="example" class="table table-striped" style="width:100%">
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-primary btn-xs edit" title="Edit"href="{{ url('editLoan/'.$p->loan_id) }}"><i class="fa fa-edit"></i></a> 
                                                <button class="btn btn-danger btn-xs delete" title="Delete" data-userid="" onclick="deleteLoan('{{$p->loan_id}}')"><i class="fa fa-trash"></i></button>
                                            </td>
                                        </tr>
                                        @endforeach
                                </tbody>
