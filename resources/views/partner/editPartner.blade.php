...
@section('title')
@parent
JFS | Channel Partner User Management
@endsection
@section('content')
@parent
<!-- Breadcrumbs -->
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('allPartners') }}">All Channel Partners</a></li>
        <li class="breadcrumb-item active" aria-current="page">Edit Channel Partner User</li>
    </ol>
</nav>

 <!-- Custom styles for this page -->
 <link href="{{ asset('theme') }}/dist-assets/vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
 <h1><center>Edit Channel Partner Information</center></h1>    
            <div class="col-xl-12 col-lg-12">
               
                 <!-- DataTales Example -->
                 <div class="d-flex justify-content-center flex-nowrap card shadow">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Edit Channel Partner User</h6>
                        </div>
                        <div class="card-body mb-12">
                            <form class="user" id="editPartnerView" method="post">
                                @csrf      
                                <div class="">
...
<script>   
    $('#editPartnerView').on('submit',function(e){
        e.preventDefault();
        $.ajax({               
            ...
            success:function(data){              
                if(data.status == 0){
                    ...
                    swal({
                        ...
                        window.location.href = "/partner/allPartners";
                    });
