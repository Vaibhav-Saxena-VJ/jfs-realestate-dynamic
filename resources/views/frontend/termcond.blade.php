...
@section('title', "Terms and Condition - Jfinserv")
@section('description', "")
...
<div class="container-fluid bg-breadcrumb">
            <div class="container text-center py-5" style="max-width: 900px;">
                <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">Terms and Condition</h4>
                <ol class="breadcrumb d-flex justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                    <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                    <li class="breadcrumb-item active text-primary">Terms and Condition</li>
                </ol>    
            </div>
        </div>
        <!-- Header End -->
            ...
            <div class="container py-5">
                <div class="row g-4 justify-content-center">
                    <div class="col-md-12 wow fadeInUp" data-wow-delay="0.2s">
                        <p>Jfinserv Consultant India Private Limited operates website https://Jfinserv.com and app under brand names Jfinserv. Jfinserv aims to simplify your financial life by providing great financial products across insurance, loans & investments. We are committed to operating our website/app with proper internal controls and strong ethical standards.</p>
                        <p class="mb-5">Please note that your use or visit to our website https://Jfinserv.com and app (together referred to as “Services”) are subject to the following terms; if you do not agree to all of the following, you may not access or use the Services in any manner.</p>
                        ...
                        <p class="mb-5">Besides, any investment decision taken by you on the Services is your sole responsibility and Jfinserv in anyway shall not be liable for any damage or loss caused to you or other users of this website/app owing to such an investment decision.</p>
