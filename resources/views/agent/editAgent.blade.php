...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb" style="margin-left: 20px;">
        ...
        <li class="breadcrumb-item"><a href="{{ route('allAgents') }}">All agents</a></li>
        <li class="breadcrumb-item active" aria-current="page">Edit Agent User</li>
    </ol>
</nav>
            ...
            <div class="col-xl-12 col-lg-12">
                 ...
                 <div class="d-flex justify-content-center flex-nowrap card shadow">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Edit Agent User</h6>
                        </div>
                        <div class="card-body mb-12">
                            <form class="user" id="editAgentView" method="post">
                                @csrf      
                                <div class="">
...
<script>   
    $('#editAgentView').on('submit',function(e){
        e.preventDefault();
        $.ajax({               
            ...
            success:function(data){              
                if(data.status == 0){
                    ...
                    swal({
                        ...
                        window.location.href = "/agent/allAgents";
                    });
